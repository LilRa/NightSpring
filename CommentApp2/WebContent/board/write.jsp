			...
			<tr>
				<td id="list"><table width="100%" border="0" cellspacing="0"
						...
						<tr id="writer">
							...
							<td><input type="text" name="rb_writer"></td>
						</tr>
						<tr id="title">
							<td height="25" align="center">제목</td>
							<td><input type="text" name="rb_title"></td>
						</tr>
						<tr id="content">
							<td align="center">내용</td>
							<td><textarea name="rb_content" style=""></textarea></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
			...
			<tr>
				<td height="30" align="right" style="padding-right: 2px;">
					<img src="images/write_btin.gif" width="61" height="20" onClick="regist()"> 
						<a href="list.jsp">
					<img src="images/list_btn.gif" width="61"height="20">
						</a>
				</td>
			</tr>
			<tr>
